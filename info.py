...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1625829733 1821331060').split()]
...
URL = "https://aj-filter-bot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://aj-filter-bot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://aj-filter-bot.onrender.com/".format(FQDN)
else:
    URL = "https://aj-filter-bot.onrender.com/".format(FQDN)
